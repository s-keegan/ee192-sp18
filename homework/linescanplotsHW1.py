...
#currently calculates line center based on argmax/min of cross correlation. Should set threshold for minimum difference values and set track_found accordingly.
